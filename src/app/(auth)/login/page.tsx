          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-[#006D77]">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <Button
                type="button"
                className="w-full inline-flex justify-center items-center bg-white hover:bg-gray-50 text-[#006D77] font-semibold border border-[#83C5BE]"
              >
                <svg
